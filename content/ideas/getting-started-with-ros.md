...
I gave GMKTec M6 the hostname of `ros` and my login is `jeff` using my standard password.


#### Step 4: Install OpenSSH - DONE
Before I removed the monitor / keyboard / mouse, I did the following:

1. I checked to make sure `ssh` was working by via `ssh jeff@ros.local` but this failed to find `roc`.
...
I rebooted `ros` and redoing the command `ssh jeff@ros.local` to validate that it now works.
...
# Enable ROS Screen Sharing
At times, I want to remote desktop into ROS so I can take full advantage of the desktop GUI menu system,
...
But both `desktop` and `ros` are Ubuntu/Gnome systems,
...
[Exercises 2 - SLAM and Navigation Demo](https://github.com/henki-robotics/robotics_essentials_ros2/blob/main/2-slam_and_navigation_demo/README.md)

#### Step 3: Exercises 3 - Create Your First Ros 2 Package
[Exercises 3 - Create Your First Ros 2 Package](https://github.com/henki-robotics/robotics_essentials_ros2/tree/main/3-create_ros_2_package)

#### Step 4: Exercises 4 - Robot Odometry 
[Exercises 4 - Robot Odometry](https://github.com/henki-robotics/robotics_essentials_ros2/tree/main/4-robot_odometry) 

#### Step 5: Exercises 5 - Path Planning 
[Exercises 5 - Path Planning ](https://github.com/henki-robotics/robotics_essentials_ros2/tree/main/5-path_planning)
