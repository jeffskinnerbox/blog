...
* [ESP32 Clock Takes Time To Give Weather Info, Too](https://hackaday.com/2021/10/27/esp32-clock-takes-time-to-give-weather-info-too/)
* [Location-Based Network Time Synchronization Using the ESP32](https://www.makeuseof.com/network-time-synchronization-using-the-esp32/)
...
* [Multiplexed Nixie Tube Clock](https://www.hackster.io/doug-domke/multiplexed-nixie-tube-clock-759ff5)
...
* [Ferrofluid Display Gets New, Better Driver Circuitry](https://hackaday.com/2021/08/26/ferrofluid-display-gets-new-better-driver-circuitry/)
...
Once in the detailed view, simply click the center again to return to the analog clock face.
...
* [Belgian Railway Station Clock](https://hackaday.io/project/183138-belgian-railway-station-clock)
...
* [LEGO Ideas: Mechanical Flip Clock](https://www.youtube.com/watch?v=f20X0adLF3o)
...
The NTP time synchronization system uses the concept of "strata" to identify how close to the source of time a computer is:

Stratum 0: These are high-precision time sources such as atomic clocks or the GPS satellite system.
Stratum 1: These are computers that directly get the time from stratum 0 devices.
